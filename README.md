...
Built for Razorpay's AI Buildathon. The model recommends recovery actions; a deterministic policy engine validates every recommendation before execution. Model output is a suggestion, never an authority.
...
**Tech:** FastAPI • Pydantic • React • PostgreSQL • Gemini/Groq
...
**Tech:** FastAPI • PostgreSQL + pgvector • Next.js • Celery/Redis • Langfuse
